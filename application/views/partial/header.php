  ...
  <div id="app">
    <div class="main-wrapper container">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        <a href="<?php echo site_url('pasien/add') ; ?>" class="navbar-brand sidebar-gone-hide">IGD</a>
        ...
        <div class="nav-collapse">
          ...
          <ul class="navbar-nav">
            <li class="nav-item active"><a href="#" class="nav-link">Administration</a></li>
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" class="nav-link notification-toggle nav-link-lg beep"><i class="far fa-bell"></i></a>
           ...
           <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="d-sm-none d-lg-inline-block">Hi, Aryo Prasetyo</div></a>
      ...
      <nav class="navbar navbar-secondary navbar-expand-lg">
        <div class="container">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a href="<?php echo site_url('pasien/index') ; ?>" class="nav-link"><i class="far fa-heart"></i><span>List Pasien</span></a>
            </li><li class="nav-item">
                <a href="<?php echo site_url('tindakan/index') ; ?>" class="nav-link"><i class="far fa-heart"></i><span>List Tindakan</span></a>
            </li>
        </div>
      </nav>
